            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/customers")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Customers">
                                    <AddLink />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Customers" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/services")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
